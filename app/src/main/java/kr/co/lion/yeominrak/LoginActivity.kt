...
import kr.co.lion.yeominrak.databinding.ActivityLoginBinding
import kr.co.lion.yeominrak.fragment.InputUserInfoFragment
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        replaceFragment(FragmentNameLogin.INPUT_USER_INFO_FRAGMENT,false,false,null)
    ...
    fun replaceFragment(name:FragmentNameLogin, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        when(name){
            FragmentNameLogin.INPUT_USER_INFO_FRAGMENT -> {
                newFragment = InputUserInfoFragment()
            }
        }
    ...
    fun removeFragment(name:FragmentNameLogin){
        SystemClock.sleep(200)
